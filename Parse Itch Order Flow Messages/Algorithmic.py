...
#The script appends the parsed result iteratively to a file in the fast HDF5 format using the store_messages() function we just defined to avoid memory constraints

#processes the binary file and produces the parsed orders stored by message type
start = time()
...
#We can now summarize the trading day
